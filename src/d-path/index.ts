          ...
          : Command extends "q" | "Q"
            ...
            : Command extends "t" | "T"
              ...
              : Command extends "a" | "A"
                ? "A"
                : never;
type toCommonCommand<AbsoluteCommand> = AbsoluteCommand extends "L"
  ? "l" | "L"
  : AbsoluteCommand extends "H"
    ? "h" | "H"
    : AbsoluteCommand extends "V"
      ? "v" | "V"
      : AbsoluteCommand extends "C"
        ? "c" | "C"
        : AbsoluteCommand extends "S"
          ? "s" | "S"
          : AbsoluteCommand extends "Q"
            ? "q" | "Q"
            : AbsoluteCommand extends "T"
              ? "t" | "T"
              : AbsoluteCommand extends "A"
                ? "a" | "A"
                : never;
...
type CreatePathSegmentInfoOverloads =
